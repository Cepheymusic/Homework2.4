public class AuthenticationValidator {
    ...
    public static void testAuthentication(String login, String password, String confirmPassword) throws WrongPasswordException {
        testLogin(login);
    ...
    private static void testPassword(String password) throws WrongPasswordException {
    ...
    private static void testConfirmPassword(String confirmPassword, String password) throws WrongPasswordException {
